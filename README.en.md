...
<p align="center"><a href="README.md">简体中文（主文档）</a> · English copy</p>
...
<p align="center">
  ...
  <a href="docs/PROVIDERS.en.md">Providers</a> &nbsp;·&nbsp;
  <a href="docs/PR_REVIEW_GUIDE.en.md">Review Guide</a> &nbsp;·&nbsp;
...
And when a run is done, hit **▶ REPLAY RUN** — the whole production replays from its timestamps, scrubbable end to end. See [`backlot/README.en.md`](backlot/README.en.md) for how it works.
...
Want more? See the full **[Prompt Gallery](PROMPT_GALLERY.en.md)** for tested prompts with expected costs and output examples, or run `make demo` to render zero-key demo videos instantly.
...
> **Full setup guide with pricing and free tiers:** [`docs/PROVIDERS.en.md`](docs/PROVIDERS.en.md)
...
See `docs/ARCHITECTURE.en.md` for the full technical reference, `docs/PROVIDERS.en.md` for the complete provider guide (setup, pricing, free tiers), and `AGENT_GUIDE.md` for the agent contract.
