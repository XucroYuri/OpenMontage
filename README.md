...
> **“一句提示词构建完整 3D 世界 (One Prompt Built This Complete 3D World)”** — 一段连续 60 秒的旅程，穿行于同一个连贯且可编辑的奇幻世界。不同地貌区、有人居住的村庄、水道、遗迹、茂密植被和后段揭晓的主地标由带纹理的 3D 资产组装，再通过电影级灯光、氛围音乐和规划好的镜头路径融为一体。
...
聊天窗口只能告诉您智能体“说了什么”，而 **Backlot 会展示制作实际正在做什么**。这个本地制作看板会随着流水线运行自动填充：阶段依次点亮，脚本以剧本页面呈现，资产生成时场景卡片持续更新，所有提供商决策和成本都清楚记录在看板上。

制作开始后，智能体会自动打开看板。无需额外配置或手工汇报；它直接读取流水线本来就会写入的项目文件。

<p align="center"><img src="docs/images/backlot/board-live.png" alt="Backlot 实时制作看板：正在生成资产" width="920"></p>

**故事板现在也是正式审批门。** 资产生成会停在逐场景联系表：其中展示候选版本、提示词、单项成本和质量评分，让您在渲染锁定素材之前批准画面，而不是等成片完成后才发现问题。
