...
> Language: **English (secondary copy)** · [简体中文（主文档）](PROMPT_GALLERY.md)
...
1. Open a [GitHub Discussion](https://github.com/calesthio/OpenMontage/discussions) in the "Prompt Exchange" category
