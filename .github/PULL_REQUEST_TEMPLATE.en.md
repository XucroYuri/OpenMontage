<!-- English copy; the primary Simplified Chinese template is PULL_REQUEST_TEMPLATE.md. -->
<!--
...
- [ ] I updated `docs/README.md` and related documentation if behavior or usage changed.
